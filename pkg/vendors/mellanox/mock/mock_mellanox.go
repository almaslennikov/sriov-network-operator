...
// Source: pkg/vendors/mellanox/mellanox.go
//
// Generated by this command:
//
//	mockgen -destination pkg/vendors/mellanox/mock/mock_mellanox.go -source pkg/vendors/mellanox/mellanox.go
//
...
func (m *MockMellanoxInterface) MlxResetFW(pciAddresses []string, mellanoxNicsStatus map[string]map[string]v1.InterfaceExt, hostHelper host.HostManagerInterface) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MlxResetFW", pciAddresses, mellanoxNicsStatus, hostHelper)
	ret0, _ := ret[0].(error)
	return ret0
}

// MlxResetFW indicates an expected call of MlxResetFW.
func (mr *MockMellanoxInterfaceMockRecorder) MlxResetFW(pciAddresses, mellanoxNicsStatus, hostHelper any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MlxResetFW", reflect.TypeOf((*MockMellanoxInterface)(nil).MlxResetFW), pciAddresses, mellanoxNicsStatus, hostHelper)
}
