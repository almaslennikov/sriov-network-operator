...
// Source: pkg/helper/host.go
//
// Generated by this command:
//
//	mockgen -destination pkg/helper/mock/mock_helper.go -source pkg/helper/host.go
//
...
func (m *MockHostHelpersInterface) MlxResetFW(pciAddresses []string, mellanoxNicsStatus map[string]map[string]v1.InterfaceExt, hostHelper host.HostManagerInterface) error {
	m.ctrl.T.Helper()
...
func (mr *MockHostHelpersInterfaceMockRecorder) MlxResetFW(pciAddresses, mellanoxNicsStatus, hostHelper any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MlxResetFW", reflect.TypeOf((*MockHostHelpersInterface)(nil).MlxResetFW), pciAddresses, mellanoxNicsStatus, hostHelper)
}
